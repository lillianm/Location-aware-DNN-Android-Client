...
public class BLEMainActivity extends ViewPagerActivity {
  // Log
  ...
  // GUI
  private static BLEMainActivity mThis = null;
  ...
  public BLEMainActivity() {
	  ...
	  mResourceIdPager = R.id.ble_pager;
  }
  ...
  private void startDeviceActivity() {
    ...
    mDeviceIntent.putExtra(MainActivity.EXTRA_DEVICE, mBluetoothDevice);
